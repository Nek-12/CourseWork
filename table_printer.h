...
namespace tprinter
{
    ...
    ** */
    ...
    public:
         ...
         */
        void useFixedPointsNotation()
        { fixed_points_notation_ = true; }

        /** \brief Sets the floatfield format flag for the str stream to fixed.
         *  e.g. 125456789.12346 will be presented as 1.2546e+08
         */
        void dontUseFixedPointsNotation()
        { fixed_points_notation_ = false; }

        /// \brief Set columns seperator
        void setSeperator(const std::string& separator)
        ...
        ** */
         ...
         *  between rows
         */
        void setDashedRawsStyle()
        { style_ = DASHED_ROWS_SEPARATION; };

        /** \brief Print lines one after another without separating
         *  dashed lines
         */
        void setStandartStyle()
        { style_ = NO_ROWS_SEPARATION; };
    ...
    private:
        ...
        template<typename T>
        static std::string typeToString(T input)
        {
